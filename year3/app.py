...
def regression():
    ...
    if request.method == 'POST':
        ...
        train_plot_path,val_plot_path,test_plot_path = obj.plot_train_val(train_loss=train_loss,train_acc=train_acc,val_acc=val_acc,val_loss=val_loss,epoches=epochs,testdl=testdl)
        return render_template('regression.html',train_plot_path=train_plot_path,val_plot_path=val_plot_path,test_plot_path=test_plot_path) 
...
def classification():
    ...
    if request.method == 'POST':
        ...
        return render_template('classification.html',train_plot_path=train_plot_path,val_plot_path=val_plot_path,test_plot_path=test_plot_path,train_view_plot_path=train_view_plot_path) 
